...
export default class Level1Scene2 extends Phaser.Scene
{
	constructor()
	{
		super('2level1')
    ...
    quiz()
    {
        ...
        if(this.quizvar == 1){
            this.question2a.setVisible(true)
        }
        if(this.quizvar == 2){
            this.question2b.setVisible(true)
        }
        if(this.quizvar == 3){
            this.question2c.setVisible(true)
        }

        this.button1.on('pointerdown', () => {
            this.question2a.setVisible(false)
            this.question2b.setVisible(false)
            this.question2c.setVisible(false)
